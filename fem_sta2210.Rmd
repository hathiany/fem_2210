...
![](images/clipboard-598918067.png){width="553"}
...
A cohort is a group of persons (animals) with a common characteristic within defined time period. e.g. people born at the same time, period e.tc.
...
identify one or more groups of individuals who share some common attribute (the ‘cohort’) • classify cohort members according to the key exposure(s) of interest DESIGN STEPS • follow-up cohort members to determine disease occurrence • relate information on disease occurrence to exposure
...
(1) Selection of cohort(s) Are cohort(s) representative of all potential cohort members? ( 2) Choice of the comparison group SOURCES OF BIAS ) p g p Do the ‘exposed’ differ from the ‘unexposed’ with respect to other factors? Healthy worker effect
(2) Ascertainment of disease status Completeness — LOSSES TO FOLLOW-UP Ascertainment without knowledge of exposure?
