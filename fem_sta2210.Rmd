...
-   RCT’s are considered, with reason, especially "strong" study designs in terms of their ability to provide evidence of causal association between risk factors and health outcomes.
...
-   Here, we present a definition of what a RCTs are, their main feature, the appropriate measures to be used to express their results, and a summary of their strengths and weaknesses

-   A  RCT is a type of **intervention** study (in which the experimenter controls the exposure, as opposed to **observational** studies, in which the exposure is determined by external factors), often used to study the fficacy/effectiveness of various type of interventions (e.g. drugs, medical procedures, preventive interventions)
