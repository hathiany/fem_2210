...
-   The following two diagrams illustrate the prospective cohort study design
    ...
    ### Key characteristics of prospective cohort studies
...
**Study Objective**: To examine the relationship between physical activity and cardiovascular disease (CVD) in adults.

**Study Design**:

1.  **Baseline recruitment**: Researchers enroll 5,000 adults aged 40-60 years who are free of CVD. Participants complete a baseline survey on their physical activity levels and other factors such as diet, smoking status, and medical history.

2.  **Follow-up**: Researchers follow participants for 10 years, during which time they periodically assess physical activity levels and monitor participants for any new diagnoses of CVD, such as heart attack or stroke.

3.  **Outcome measurement**: Incidence of CVD is tracked through regular medical check-ups and review of medical records.

4.  **Data analysis**: The incidence of CVD in high-activity participants is compared to that in low-activity participants to determine if higher physical activity levels are associated with a reduced risk of CVD.

**Findings**:

-   Suppose the study finds that participants with higher physical activity levels have a significantly lower incidence of CVD compared to those with lower activity levels.

**Interpretation**:

-   This finding suggests a possible protective effect of physical activity against CVD. Because the study is prospective, with exposure measured before the outcome, there is stronger evidence to support a causal relationship.

### Key Measures in Prospective Cohort Studies

1.  **Incidence rate**: The rate at which new cases of the outcome occur in a population over time.

    ${\text{Incidence Rate(IR)}} = \frac{\text{Number of new cases}}{\text{Person-time at risk}}$

2.  **Relative Risk (RR)**: A measure that compares the risk of the outcome in the exposed group to the risk in the unexposed group.

    $\text{Relative Risk (RR)} = \frac{\text{Incidence in exposed group}}{\text{Incidence in unexposed group}}$

3.  **Attributable Risk (AR)**: The difference in incidence between exposed and unexposed groups, representing the incidence of disease that could potentially be prevented if the exposure were eliminated.

    $\text{Attributable Risk (AR)} = \text{Incidence in exposed} - \text{Incidence in unexposed}$

**In summary**

-   **Prospective cohort** studies are a gold standard for studying the effects of risk factors on the development of disease over time.

-   They provide essential data on incidence, enable the study of multiple outcomes from a single exposure, and support a temporal sequence between exposure and outcome. However, they require significant resources and are susceptible to biases from loss to follow-up and confounding.

-   Despite these challenges, prospective cohort studies are among the most powerful observational designs for exploring causality in epidemiology.

The **key features** of cohort studies include;

-   **Longitudinal Follow-Up**: Cohort studies are designed to observe participants over a specified period, which may be ***months, years, or even decades***. They measure the incidence (new cases) of a disease or outcome over time.

-   **Exposed vs. Unexposed Groups**: A cohort study typically starts by identifying two groups within the cohort: those who have been exposed to a risk factor or intervention (e.g., smokers) and those who have not (e.g., non-smokers). The study then tracks outcomes in both groups to assess any association with the exposure.

-   **Prospective vs. Retrospective Cohort Studies**

    -   **Prospective Cohort Study**: Enrolls participants and follows them into the future. Data on exposure and other variables are collected at the start and monitored over time.

    -   **Retrospective Cohort Study**: Uses past records to determine participants’ exposure status and follows them up to the present to assess outcomes. It’s faster and less expensive than prospective studies but relies on the availability and accuracy of historical data.

<!-- -->

-   **Temporal Relationship**: Since exposure is measured before the outcome occurs, cohort studies can establish a temporal sequence, which strengthens causal inferences.

Design steps

identify one or more groups of individuals who share some common attribute (the ‘cohort’) • classify cohort members according to the key exposure(s) of interest • follow-up cohort members to determine disease occurrence • relate information on disease occurrence to exposure

strengths

They can be used to study relatively **rare exposures**

(1) They can be used to study a **wide range of disease outcomes**

(2) Information on **exposure** relates to time period **before disease onset**

(3) Detailed information on **confounding factors** can be collected

(4) Detailed data on exposure permits opportunity to study **‘dose-response’ relationships**
...
(7) Time required to conduct the study — and losses to follow-up Because of the strengths and weaknesses, cohort studies are most often used when the disease of interest is common and/or the effects of the exposure are nonspecific or not well-defined

    sources of bias

(8) Selection of cohort(s) Are cohort(s) representative of all potential cohort members? ( 2) Choice of the comparison group p g p Do the ‘exposed’ differ from the ‘unexposed’ with respect to other factors? Healthy worker effect

(9) Ascertainment of disease status Completeness — LOSSES TO FOLLOW-UP Ascertainment without knowledge of exposure?

Analysis

a\. Comparison of disease rates in cohort with rates in general population

b\. Compare disease risk (or rate) in exposed cohort members with unexposed cohort members

Comparison of cohort groups

RR, RR, OR

##### A pictorial illustration of the study designs considered
