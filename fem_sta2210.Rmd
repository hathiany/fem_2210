...
-   **Incidence rate**: The rate at which new cases of the outcome occur in a population over time.

    ![](images/clipboard-260987568.png){width="252" height="36"}

-   **Relative Risk (RR)**: A measure that compares the risk of the outcome in the exposed group to the risk in the unexposed group.

    ![](images/clipboard-1215194790.png){width="362"}

-   **Attributable Risk (AR)**: The difference in incidence between exposed and unexposed groups, representing the incidence of disease that could potentially be prevented if the exposure were eliminated.
...
A **retrospective cohort study** is an observational study design where researchers look back in time to examine how past exposures affect current outcomes. In this type of study, both the exposure and the outcome have already occurred by the time the study begins, but the design still involves following the cohort from exposure to outcome in a chronological sequence.
